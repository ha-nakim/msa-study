...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to fetch loan details based on a mobile number.  \n eureka 서버에 등록 된 registry정보를 이용해서 OpenFeign으로 loan 서버에 /fetch를 호출하여 정보 조회 "
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            summary = "Fetch Card server Host Info REST API",
    ...
    @GetMapping("/fetchLoanHostInfo")
    public ResponseEntity<Map<String, String>> fetchLoanHostInfo() {
      Map<String, String> rsMap = iCardsService.fetchHostInfo();
      return ResponseEntity.status(HttpStatus.OK).body(rsMap);
    }
