...
import com.eazybytes.cards.feignClient.LoansDetailsClient;
...
public class CardsServiceImpl implements ICardsService {
    ...
    private LoansDetailsClient loansDetailsClient;
    ...
    public LoansDto fetchTotalLoan(String mobileNumber) {
      LoansDto loan = loansDetailsClient.fetchLoanDetails(mobileNumber).orElseThrow(
